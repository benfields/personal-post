...
this code is licensed under two (2) source code licenses, mine ("me" or "I" refer to "Ben Fields") and the Public Domian (CC0) lisence. My license can be found at the end of this file (README.md), and the Public Domain (CC0) license can be found in the LICENSE file.
